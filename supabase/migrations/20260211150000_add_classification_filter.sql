-- Migration to add classification filter to dashboard analytics functions
...
BEGIN
    ...
    -- Calculate avg rejection (simplified)
...
-- 4. RPC: Get Vacancies by Classification
